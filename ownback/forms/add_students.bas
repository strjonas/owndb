...
'------------------------------------------------------------
' btn_add_student_Click
'
'------------------------------------------------------------
Private Sub btn_add_student_Click()
    DoCmd.RunCommand acCmdSaveRecord
'    DoCmd.OpenForm "show_students"
...
Private Sub load_data()
    ...
    If DCount("id", "students", "s_number=" & txt_id.Value) = 0 Then
        DoCmd.RunSQL ("insert into students (s_number) values (" & txt_id.Value & ");")
    End If
