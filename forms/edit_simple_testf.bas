        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    LayoutCachedTop =11398
                    LayoutCachedWidth =679
                ...
                Begin CommandButton
                    ...
                    LayoutCachedWidth =9631
                    LayoutCachedHeight =11284
                    BackColor =15123357
...
Sub load_data()
    ...
    If Not IsNull(DLookup("csv_data", "simple_testf", "id=" & ID)) Then
    ...
    F_DATA.init data:=data, max_w:=13, max_h:=13, del_row:=vbCr, del_col:=","
    
    ' Get Data to fill into edit form
    With Me
        .txt_name.Value = DLookup("str_name", "simple_testf", "id=" & ID)
        .txt_memo.Value = DLookup("str_bem", "simple_testf", "id=" & ID)
    End With
...
Private Sub btn_save_Click()
    ...
    Dim data: data = F_DATA.get_str_data
    Dim bem: bem = txt_memo.Value
...
Function update_data_from_form()
    ...
    For rc = 0 To max_h
        ...
        For cc = 0 To max_w
            data = data & Me("txt_" & rc & "_" & cc & "").Value
...
Function update_form_from_data()
    ...
    For rc = 0 To max_h
        ...
        For cc = 0 To max_w
            ...
            Me("txt_" & rc & "_" & cc & "").Value = data(rc, cc)
...
Function update_temptable_from_data()
    ...
    Dim data() As String: data = F_DATA.get_arr_data
    Dim bem As String: bem = v_or_emp(Me.txt_memo.Value) ' v_or_emp siehe funcs
    ...
    For rc = 0 To max_h
        ...
        For cc = 0 To max_w
            ...
            ' DoCmd.RunSQL "alter table temp_testf add column str_" & rc & "_" & cc & " Text;"
